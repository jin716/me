...
&emsp;&emsp;远光九天智能语言，是公司为实现低代码开发的战略方向性研发。其目的一个是降低对国外开源软件的依赖，另一个是结合自身情况降低代码开发代码量。
我负责的工作包括：  
１.YJDL远光九天模型语言的开发设计：  
...
&emsp;&emsp;在北理工，北师范，省财校， 江西财经等周边多个院校进行合作，教授微服务开发基础。

&emsp;&emsp;北理工签约毕业生辅导教师，指导毕业设计等工作。
