...
## 工作经历
## 2017年4月-至今 远光软件信创平台部 安可语言组开发经理&技术平台部架构师 
  
#### 主要项目经历

#### 远光低代码开发平台 远光九天智能语言研发 2021年10月-至今

&emsp;&emsp;远光九天智能语言，是公司平台部为实现低代码开发的智能语言。其目的一个是降低对国外开源软件的依赖，另一个是结合公司情况进行低代码方向的探索。
我负责的工作包括：  
1. YJDL远光九天模型语言的开发设计，包括模型操作，元数据获取，基础服务，变量，多线程库等接口。
...
难点与解决：
SQL解析引擎：需要对复杂SQL语句进行语法分析，追溯语句中的列名，所属表名，提取并替换，最终达到模型与数据库实现解耦。通过基于ANTLR开发的Druid Sqlparser开源工具，基于分析树的递归算法对SQL的表名，列名进行解析替换，实现模型定义与具体SQL规范的转换，最终实现一次编写，多种数据库实现运行的目的，极大简化了开发团队的开发效率。


#### 国家电网财务管控应用分离架构转型 2019年6月-2020年4月

&emsp;&emsp;作为主要核心人员全程参与，将公司原有软件系统架构从传统单体架构转型微服务化，我负责的工作包括以下几个过程：
...
#### AI中心服务与组件
* 自然语言处理，OCR图像识别， 人脸识别等多种AI服务的接入适配.

#### 远光星火计划高校金牌讲师计划 企业指导教师
&emsp;&emsp;在北京理工大学珠海学院，北京师范大学珠海分校，广东财经大学， 江西财经大学等周边多个院校进行合作，教授微服务开发基础及生产开发实践。  
&emsp;&emsp;北京理工大学珠海学院签约毕业生辅导教师，指导毕业设计等工作。


## 2015年8月-2017年4月 工行珠海研发中心 CCF平台研发工程师（非编制）
